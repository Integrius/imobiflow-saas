            ...
            <div>
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="mt-2 p-3 bg-[#DFF9C7]/30 border border-[#8FD14F]/30 rounded-lg">
                    <p className="text-[#6E9B3B] text-xs font-medium">
                      🌐 Seu endereço será: <span className="font-bold">{formData.slug || 'seu-subdominio'}.integrius.com.br</span>
                    </p>
                  </div>
                </div>
