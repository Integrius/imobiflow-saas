    ...
    <div className="min-h-screen bg-white relative">
      ...
      <section className="py-16 px-6 bg-white border-y border-gray-100 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          ...
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#00C48C] rounded-full translate-x-1/3 translate-y-1/3" />
        </div>

        <div className="max-w-4xl mx-auto relative z-10 text-center">
          <div className="inline-block bg-[#064E3B] text-white font-extrabold text-sm px-4 py-1.5 rounded-full mb-6 uppercase tracking-wide">
            Campanha de Lançamento
          </div>

          <h2 className="text-3xl md:text-5xl font-extrabold text-[#064E3B] mb-4 leading-tight">
            60 dias grátis para os<br />
            <span className="text-[#00C48C]">20 primeiros cadastrados</span>
          </h2>

          <p className="text-lg md:text-xl text-gray-700 mb-3 max-w-2xl mx-auto">
            Estamos inaugurando o Integrius e queremos que você faça parte dessa história!
            Cadastre-se agora e experimente nosso CRM completo por <strong className="text-[#064E3B]">60 dias sem custo algum</strong>.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <Link
              href="/register"
              className="bg-[#064E3B] text-white font-bold px-8 py-4 rounded-xl text-lg shadow-lg hover:bg-[#047857] hover:shadow-xl transition-all hover:scale-105"
            >
              Garantir Minha Vaga
            </Link>
            <div className="text-gray-500 text-sm">
              <span className="block font-semibold text-[#064E3B]">Vagas limitadas</span>
          ...
          <div className="grid grid-cols-3 gap-6 max-w-md mx-auto">
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-[#064E3B]">60</div>
              <div className="text-gray-500 text-xs">Dias Grátis</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-[#064E3B]">20</div>
              <div className="text-gray-500 text-xs">Vagas Disponíveis</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-[#064E3B]">R$0</div>
              <div className="text-gray-500 text-xs">Sem Cartão</div>
            </div>
          </div>
        </div>
      </section>
